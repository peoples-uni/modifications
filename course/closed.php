...
echo '<p><strong>If you want to enrol as a new student (i.e. you are not already registered on our Moodle system), you need to register first by </strong><a href="https://courses.peoples-uni.org/course/registration.php">Clicking Here</a><strong>. You will be enrolled in a free pre-semester Preparing to Study Programme.<br />About 2 months before semester start, you will also be invited to apply for the module(s) of your choice - please don\'t miss this step, otherwise you will not be enrolled in the next semester.</strong></p>';

//echo '<p><strong>If you wish to apply to Peoples-uni in the upcoming semester please read the information on </strong><a href="https://peoples-uni.org/content/course-fees">Course Fees (Click Here)</a><strong> to make sure that you are prepared.</strong></p>';

//echo '<p><strong>If you have not been registered in Moodle you must apply by </strong><a href="https://courses.peoples-uni.org/course/registration.php">Clicking Here</a></p>';
