...
CREATE TABLE mdl_peoples_survey (
  ...
  interested_deliver_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  informed_deliver_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  ...
  interested_deliver_body_2 VARCHAR(35) NOT NULL DEFAULT '',
  informed_deliver_body_2 VARCHAR(35) NOT NULL DEFAULT '',
  ...
  interested_fund_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  informed_fund_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  best_way_fund_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  fund_body_2 TEXT NOT NULL,
  country_fund_body_2 VARCHAR(2) NOT NULL DEFAULT '',
  interested_fund_body_2 VARCHAR(35) NOT NULL DEFAULT '',
  informed_fund_body_2 VARCHAR(35) NOT NULL DEFAULT '',
  ...
  interested_care_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  informed_care_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  best_way_care_body_1 VARCHAR(35) NOT NULL DEFAULT '',
  care_body_2 TEXT NOT NULL,
  country_care_body_2 VARCHAR(2) NOT NULL DEFAULT '',
  interested_care_body_2 VARCHAR(35) NOT NULL DEFAULT '',
  informed_care_body_2 VARCHAR(35) NOT NULL DEFAULT '',
