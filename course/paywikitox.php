<?php  // $Id: paywikitox.php,v 1.1 2011/02/27 15:54:00 alanbarrett Exp $
/**
*
* Pay for a WikiTox Course
*
*/
...
echo '<p><b>Enter the amount 1120 UK Pounds if you wish to pay for one year of the course or 2000 UK Pounds if you wish to pay for the full course and also enter your contact information and then click the button below to make your payment with RBS WorldPay.</b></p>';
...
<input type="hidden" name="cartId" value="WikiTox <?php echo $donatetime; ?>" />
<input type="hidden" name="currency" value="GBP" />

<strong>Amount you wish to Pay (in UK Pounds):&nbsp;</strong><input type="text" size="10" name="amount" /><br /><br />
<input type="hidden" name="desc" value="WikiTox Course Payment <?php echo $donatetime; ?>" />
...
<br />
<input type="hidden" name="M_wikitox" value="<?php echo $donatetime; ?>" />
