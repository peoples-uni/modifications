...
SELECT m.id, m.semester_graduated, m.mphstatus, m.graduated, m.entitled, m.willpay, u.id as userid, u.lastname, u.firstname, u.email, u.country
...
if (!empty($enrols)) {
    ...
    $rowdata[] = $type_of_entitled[$enrol->willpay];
