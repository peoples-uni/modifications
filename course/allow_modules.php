...
echo '</table>';
?>
<form id="addsemesterform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
?>
<form id="setlastdateform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
if (!$closed) {
?>
<form id="closesemesterform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<form id="addnewmoduleform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
?>
<form id="addfoundationform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<form id="addproblemsform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<form id="setstudentscornerform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<br />
<form id="setfphform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<br />
<form id="setsscform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
?>
<br />
<form id="setssfform" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<input type="hidden" name="sesskey" value="<?php echo $USER->sesskey ?>" />
...
<form id="register_ack_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="register_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="batch_registration_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<?php if (FALSE) { ?>
<form id="approval_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="approval_bursary_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="approval_old_students_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="approval_old_students_bursary_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="batch_reminder_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="batch_email_to_enrolled_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<?php if (FALSE) { ?>
<form id="interest_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="batch_email_to_enrolled_missing_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="discussion_feedback_email_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
<textarea name="value_discussion_feedback_email" rows="15" cols="75" wrap="soft" style="width:auto">
...
<form id="track_submissions_exclusions_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
...
<form id="track_quizzes_exclusions_form" method="post" action="<?php echo $CFG->wwwroot . '/course/allow_modules.php'; ?>">
