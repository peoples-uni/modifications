...
/**
 * Registration form for Peoples-uni Students (to be used by Tech Support) (Form Class)
 * registration_manual_form.php
 */
...
class registration_manual_form extends moodleform {
  ...
  function definition() {
    ...
    $mform->addElement('static', 'instuctions', '','<strong>Manual Registation of a Student</strong>');
