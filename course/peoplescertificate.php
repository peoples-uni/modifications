...
if ($cert == 'transcript') {
  ...
  if ($certdate > 1480550400) { // December 1st 2016
    if (stripos($course->fullname , 'dissertation') === FALSE) { // Not Masters dissertation
      cert_printtext(170, 350, 'C', 'Helvetica', '', 14, utf8_decode('This carries 15 credits towards a Peoples-uni award,'));
      cert_printtext(170, 380, 'C', 'Helvetica', '', 14, utf8_decode(' and 6 credits towards the European Credit Transfer System.'));
    }
    else { // Masters dissertation
      cert_printtext(170, 350, 'C', 'Helvetica', '', 14, utf8_decode('This carries 60 credits towards a Peoples-uni award,'));
      cert_printtext(170, 380, 'C', 'Helvetica', '', 14, utf8_decode(' and 30 credits towards the European Credit Transfer System.'));
    }
  }
  elseif ($certdate > 1291161600) { // December 1st 2010
    if (stripos($course->fullname , 'dissertation') === FALSE) { // Not Masters dissertation
