...
');
    ...
    $mform->addElement('text', 'fund_body', 'Names of Bodies Indicated Above', 'maxlength="255" size="50"');
    ...
    $mform->addElement('text', 'care_body', 'Names of Bodies Indicated Above', 'maxlength="255" size="50"');
