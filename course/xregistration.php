...
require_once('xregistration_form.php');
...
$editform = new xregistration_form(NULL, array('customdata' => array()));
...
elseif ($data = $editform->get_data()) {
  ...
  $peoples_register_ack_email = get_config(NULL, 'peoples_register_ack_email');
  $peoples_register_ack_email = str_replace('GIVEN_NAME_HERE', $application->firstname, $peoples_register_ack_email);
  ...
  $message .= "\n\n";
  $message .= "!!!IGNORE TEST CODE!!!Registration request for...\n\n";
...
$PAGE->set_title("TEST CODEPeople's Open Access Education Initiative Registration Form");
$PAGE->set_heading('TEST Peoples-uni Registration Form');
