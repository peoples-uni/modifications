...
Note: In <a href="http://courses.peoples-uni.org/course/studentprogress.php" target="_blank">http://courses.peoples-uni.org/course/studentprogress.php</a> "Some Discounted!" is displayed in the last column on the right to indicate that modules have been discounted for any of the academic reasons indicated above. Note once a student has broken a limit such as 10 semesters or a maximum number of fails, if it is desired that extra modules that are passed over time should be counted, each new module to be counted will continue to need to be overridden individually.<br />
The above describes the new rules that came into place in the semester "Starting March 2015", and the older rules that applied before that with not be retrospectively changed.<br />
