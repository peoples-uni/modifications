...
Note: <a href="http://courses.peoples-uni.org/course/payment_history.php">http://courses.peoples-uni.org/course/payment_history.php</a> allows staff ("Manager") to see a summary of accounts for all students for a semester. There are links to "Update Payment Amounts, Method or Confirmed Status" and some filters.<br />
Note: <a href="http://courses.peoples-uni.org/course/bursary.php">http://courses.peoples-uni.org/course/bursary.php</a> allows staff ("Manager") to see those students who have been awarded a Bursary (the word "Bursary" has been used in an account entry detail). There are various filters available.
</li>
<li>
