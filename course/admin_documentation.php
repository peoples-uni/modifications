...
If any of the transactions for this student are "(not confirmed)", this will be indicated. This can be used to find what payments need to be audited.
</li>
<li>
...
<li>
"e-mail Applicant" allows an e-mail to be sent to the Applicant, the e-mail to be sent can be edited. the e-mail will come from techsupport@peoples-uni.org as does the approval e-mail. Note these e-mails are copied to the e-mail address applicationresponses@peoples-uni.org.
</li>
<li>
