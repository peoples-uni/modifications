<?php  // $Id: donate_occ.php,v 1.1 2009/05/25 07:57:00 alanbarrett Exp $
/**
*
* Make a Donation via WorldPay
*
*/
...
/*
CREATE TABLE mdl_peoplesdonation (
	...
	address TEXT,
	country VARCHAR(2),
	M_keep TINYINT(2) UNSIGNED,
	M_donate BIGINT(10) UNSIGNED,
...
$PAGE->set_url('/course/donate_occ.php');
...
echo "<p>Enter the amount you wish to donate and your contact information (if you wish) and then click the button below to make your donation with RBS WorldPay.</p>";
...
function verify() {
	...
	if (amount < 1) {
    //alert("The amount you donate must be at least 25 Pounds, please input it again");
		alert("The amount you donate must be at least 1 Pounds, please input it again");
		document.donateform.amount.focus();
		return false;
	}
...
<input type="hidden" name="cartId" value="Donation <?php echo $donatetime; ?>" />
<input type="hidden" name="currency" value="GBP" />

<strong>Amount you wish to Donate (in UK Pounds):&nbsp;</strong><input type="text" size="10" name="amount" /><br /><br />
<input type="hidden" name="desc" value="Donation <?php echo $donatetime; ?>" />
...
?>
All the following are optional (although RBS WorldPay will ask for them, if you do not provide them to Peoples-uni)...
...
<br />
Allow Peoples-uni to keep a record of your details and possibly contact you:&nbsp;<input type="checkbox" name="M_keep" checked><br />
Allow Peoples-uni to display your name (but no other details) on our website as a supporter:&nbsp;<input type="checkbox" name="M_displaysupporter" checked><br />
<br />
<input type="hidden" name="M_donate" value="<?php echo $donatetime; ?>" />
<input type="submit" value="Click this to go to the RBS WorldPay website to securely make your donation" />
