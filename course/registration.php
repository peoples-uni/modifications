...
elseif ($data = $editform->get_data()) {
  ...
  $message .= "\n";
  $message .= "Welcome to Peoples-uni. You have been enrolled in pre-registration\n";
  $message .= "system for Peoples-uni courses.\n";
  $message .= "\n";
  $message .= "We have found in the past that those students who fully understand\n";
  $message .= "what they are letting themselves in for, do much better in the\n";
  $message .= "courses than some who are new to our e-learning platform.\n";
  $message .= "\n";
  $message .= "Since there are more people interested in taking our courses than we\n";
  $message .= "have places available, we have developed this pre-registration system\n";
  $message .= "which is a requirement for enrolment in Peoples-uni courses.\n";
  $message .= "\n";
  $message .= "The pre-registration process involves refreshing your academic skills\n";
  $message .= "by taking part in online discussions with your student support group.\n";
  $message .= "Student support groups begin in July/August and January/February.\n";
  $message .= "You will be sent an email with the exact starting date 2 weeks in\n";
  $message .= "advance, and a separate email with your username and password.\n";
  $message .= "\n";
  $message .= "In preparation for this you can do the following:\n";
  $message .= "\n";
  $message .= "1. Read the Are you Ready materials on the website and check that\n";
  $message .= "you are prepared to study:\n";
  $message .= "http://www.peoples-uni.org/content/are-you-ready-peoples-uni\n";
  $message .= "\n";
  $message .= "2. Think about your study plan and when you will study -\n";
  $message .= "You will need to make sure you can log on and read the discussions a\n";
  $message .= "minimum of once per week, but to get the best out of the forums we\n";
  $message .= "expect you to read and respond to others forum posts every few days.\n";
  $message .= "\n";
  $message .= "3. *Read the student handbook*:\n";
  $message .= "http://www.peoples-uni.org/content/student-handbook\n";
  $message .= "\n";
  $message .= "4. You may want to complete our open access Foundations in Public\n";
  $message .= "Health module (not obligatory) - you can access this online at:\n";
  $message .= "http://courses.peoples-uni.org/course/view.php?id=308\n";
  $message .= "\n";
  $message .= "There are lots of resources for you to read, which will help you\n";
  $message .= "learn key public health terms. This module is self directed learning\n";
  $message .= "and there are no tutor led discussions.\n";
  $message .= "\n";
  $message .= "Note:\n";
  $message .= "Successfully completing the pre-registration requirements is a\n";
  $message .= "pre-requisite to course enrollment. The course enrollment window\n";
  $message .= "opens twice every year - March and August, and this is when you\n";
  $message .= "select the course(s) you wish to enroll in for the current semester.\n";
  $message .= "You will be reminded when the course enrollment window is open.\n";
  $message .= "\n";
  $message .= "If you have technical problems please email apply@peoples-uni.org\n";
