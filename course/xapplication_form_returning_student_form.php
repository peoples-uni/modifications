...
//Please do not apply if this is your first semester.<br /><br />');
    ...
    $listforselect = array();
    $listforselect[1] = 'Yes, I will submit the final assignment for the module(s)';
    $listforselect[2] = 'I will complete the module(s) without taking the final assignment, but would like to earn a Certificate of Participation';
    $listforselect[3] = 'I will study the module materials without actively participating in discussions';
    $mform->addElement('select', 'take_final_assignment', 'Do you intend to take the Final Assignment?', $listforselect);
