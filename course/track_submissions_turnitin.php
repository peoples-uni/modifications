...
foreach ($track_submissions as $index => $track_submission) {
  ...
  $number_of_submissions = $number_of_submissions_by_course_by_user[$course_code_by_courseid[$track_submission->courseid] . '#' . $track_submission->userid]->number_submissions;
