...
foreach ($applications as $sid => $application) {
  ...
  $scholarshipempty = empty(trim($application->scholarship)) || (trim($application->scholarship) ==  'none') || (trim($application->scholarship) ==  'n/a') || (trim($application->scholarship) ==  'none.');
